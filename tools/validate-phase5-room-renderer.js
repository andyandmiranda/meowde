...
assert(companion.includes('["renderReview","renderProfile","renderAchievements"].forEach(wrapRenderer)'),'v443 wrappers exclude Room, My, Home, and Learn');
...
assert(cutouts.includes('["renderLesson","renderReview","renderProfile","renderAchievements","finish"]'),'character cutout wrappers exclude Room, My, Home, and Learn');
